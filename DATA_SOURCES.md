...
| **WSL Institute for Snow and Avalanche Research SLF** | IMIS Alpine measurement stations (snow depth, wind, air and snow-surface temperature) | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/), free and keyless via `measurement-api.slf.ch` | "WSL Institute for Snow and Avalanche Research SLF — IMIS network (CC BY 4.0)" |
